...
local Library do
    ...
    Library.CreateSettingsPage = function(self, Window)
        ...
        do 
            local GeneralSubPage = SettingsPage:SubPage({Name = "General", Columns = 2}) do
                GeneralSection = GeneralSubPage:Section({Name = "General", Side = 1}) do
                    -- Empty section - populated in examples
                end
            end
