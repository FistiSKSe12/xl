...
local Library do
    ...
    Library.Theme = TableClone(Themes["Aimware"])
    ...
    local Instances = { } do
        ...
        Instances.ChangeItemTheme = function(self, Properties)
            ...
            if Library and Library.ChangeItemTheme then
    ...
    Library.CreateSettingsPage = function(self, Window)
        ...
        do 
            local GeneralSubPage = SettingsPage:SubPage({Name = "General", Columns = 2})
            GeneralSection = GeneralSubPage:Section({Name = "General", Side = 1})
        end

        do
            local ThemingSubPage = SettingsPage:SubPage({Name = "Theming", Columns = 2}) 
            
            local ThemePresetsSection = ThemingSubPage:Section({Name = "Theme Presets", Side = 2})
        ...
        return SettingsPage, GeneralSection
    end
